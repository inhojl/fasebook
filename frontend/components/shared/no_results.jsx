...
const NoResults = () => {
  return (
    <div className='no-results'>
      <div className='no-results__icon'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112 112">
          ...
          <g id="No_Results" data-name="No Results">
            ...
            <path strokeWidth="3.45" strokeMiterlimit="10" strokeLinecap="round" stroke="#000" fill="none" d="M42.77 51.62l-17.71 49.09" />
            <path stroke="#64676b" strokeWidth="3.45" strokeMiterlimit="10" strokeLinecap="round" fill="none" d="M40.22 49.53l16.22 56.04" />
            ...
            <path strokeLinejoin="round" strokeWidth="8.62" stroke="#1877f2" strokeLinecap="round" fill="none" d="M82.25 35.33l-4.15 9.8-11.91-6.06" />
            <path strokeWidth="13.78" stroke="#1877f2" fill="#1876f2" strokeMiterlimit="10" d="M102.2 62.5v37.51" />
      ...
      <span className='no-results__heading'>
        We didn't find any results
      </span>
      <span className='no-results__message-1'>
        Make sure everything is spelled correctly or try different
      </span>
      <span className='no-results__message-2'>
        keywords.
      </span>
    </div>
  );
