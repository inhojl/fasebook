...
const AboutHeader = ({ user }) => {
  ...
  return (
    <nav className='about-header'>
      ...
      <PathNavLink
        exact to={`/${user.id}/about?section=relationships`}
